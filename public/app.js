...
function normalizePrevisionCanon(v) {
  ...
  const map = {
    'ISAPRE NUEVA MASVIDA': 'NUEVA MAS VIDA',
    'ISAPRE NUEVA MAS VIDA': 'NUEVA MAS VIDA',
    'NUEVA MASVIDA': 'NUEVA MAS VIDA',
